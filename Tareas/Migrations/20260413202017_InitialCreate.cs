    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerfilesUsuarios", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorSemaforo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    RutaArchivoApoyo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NombreArchivoApoyo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TipoArchivoApoyo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetroalimentacionDocente = table.Column<string>(type: "nvarchar(max)", nullable: true),
